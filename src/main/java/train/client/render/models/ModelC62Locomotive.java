...
public class ModelC62Locomotive extends ModelConverter //Same as Filename
{
	...
	public void render(Entity entity, float f0, float f1, float f2, float f3, float f4, float scale){
		...
		Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation,Info.trainsPrefix +"c62_front_"+((EntityRollingStock)entity).getSkin() + ".png"));
		GL11.glPushMatrix();
		GL11.glTranslatef(-5.75f,-0.15f,0);
		frontBogie.render();
		Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation,Info.trainsPrefix +"c62_back_"+((EntityRollingStock)entity).getSkin() + ".png"));
		GL11.glTranslatef(5.75f,0.15f,0);
		rearBogie.render();
		GL11.glPopMatrix();
	}
