...
public class EntityRotativeDigger extends Entity implements IInventory {
    ...
    public EntityRotativeDigger(World world) {
        ...
        this.dataWatcher.addObject(21, start);
    ...
    public Vec3 rotate(double x, double y, double z) {
        ...
        double v = (-x * sinRoll + y * cosRoll) * 0 + z * 0.01745;
        double newX = (-x * cosRoll - y * sinRoll) * cosYaw + v * sinYaw;
    ...
    public void onUpdate() {
        ...
        if (worldObj.isRemote) {
            if (field_9394_d > 0) {
                ...
                rotationYaw += (float) (d12 / field_9394_d);
                rotationPitch += (float) ((field_9389_i - rotationPitch) / field_9394_d);
                field_9394_d--;
